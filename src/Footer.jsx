...
function Footer() {
  return (
    <div className="bg-gray-800 text-white lg:flex space-x-5  ">
      <div className="space-y-5 mt-16 ml-10">
        ...
        <div className="flex flex-col">
          <h1>Copyright © 2022 Servet SaGaR. All Rights Reserved</h1>
        </div>
      </div>
      <div className="space-y-5 mt-16  ">
        <h1>Latest news</h1>
        <h1 className=" mr-32">
          Pleasures have to repudiated annoyances accepted therefore always
          holds chooses to enjoy a pleasure consequences.
        </h1>
        <h1 className="mr-32">
          Greater pleasures else esndures pains avoid sorse pains dolorm fugiat
          pleasure is to be welcomed avoided pariatu
        </h1>
      </div>
